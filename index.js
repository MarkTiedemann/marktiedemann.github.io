document.addEventListener('DOMContentLoaded', function () {
  ...
  function toggleDarkMode () {
    ...
    mode.innerHTML = sun
    try { window.localStorage.setItem('mode', 'dark') } catch (e) {}
  }
  ...
  function toggleLightMode () {
    ...
    mode.innerHTML = moon
    try { window.localStorage.setItem('mode', 'light') } catch (e) {}
  }

  try { if (window.localStorage.getItem('mode') === 'dark') toggleDarkMode() } catch (e) {}
